...
const Footer = () => {
  return (
    <div className='bg-base-200'>
        ...
        <footer className="footer p-10 bg-base-200 text-base-content mx-auto max-w-7xl">
        ...
        <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 mx-auto max-w-7xl">
            <aside className="items-center grid-flow-col">
                ...
                <p>JS Blog <br/>News and Guides for all your tech needs</p>
            </aside> 
