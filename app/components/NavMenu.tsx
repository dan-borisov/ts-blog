...
const NavMenu = () => {
  return (
    ...
    <div className='mx-auto max-w-5xl overflow-x-scroll flex py-2 text-neutral-content'>          
        <Link href='/' className='pr-4 font-bold hover:text-base-100'>HOME</Link>
        <Link href='/categories/guides' className='pr-4 font-bold hover:text-base-100'>GUIDES</Link>
        <Link href='/categories/history' className='pr-4 font-bold hover:text-base-100'>HISTORY</Link>
        <Link href='/categories/longReads' className='pr-4 font-bold hover:text-base-100'>LONGREADS</Link>
